...
## Download settings
KC_ASDF_DOWNLOAD_URL="https://github.com/gruntwork-io/terragrunt/releases/download/v{version}/terragrunt_{os}_{arch}"
KC_ASDF_DOWNLOAD_NAME="terragrunt_{os}_{arch}"
KC_ASDF_CHECKSUM_URL="https://github.com/gruntwork-io/terragrunt/releases/download/v{version}/SHA256SUMS"
